...
def check_slips(start_date,end_date):
    ...
    """, (start_date, end_date), as_dict=True)# frappe.errprint(start_date)
...
def make_xlsx(data, sheet_name=None, wb=None, column_widths=None):
    ...
    # check_slips(args.start_date,args.end_date)
